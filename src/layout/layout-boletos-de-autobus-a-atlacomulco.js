...
class AppBoletosAutobusAtlacomulco extends HTMLElement {
  async connectedCallback() {
    this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../src/assets/img/banner/Atlacomulco_Banner_web.webp","mediumImage": "./src/assets/img/banner/banner-monterrey-tablet.png", "smallImage": "./src/assets/img/banner/banner-monterrey-sm.png", "link": "#index.html/banner1"}]'
            >
            </app-banner-slider>
...
customElements.define(
  "layout-boletos-de-autobus-a-atlacomulco",
