document.addEventListener("DOMContentLoaded", function () {
	...
	function updateLoginIcon(profileData) {
		loginIcon.innerHTML = profileData
			? `<a href="#" id="open-profile-modal"><img src="../src/assets/img/gho-img-web/iconos/icono-travel-pass.webp" class="icono-travel" alt="Travel Pass" title="Perfil Travel Pass"> Hola, ${profileData.name}</a>`
			: `<a id="open-login-modal" href="#" class="btn-travelpass-icon"><img src="../src/assets/img/gho-img/logos/logo-travel-pass.png" alt="Iniciar sesión en Travel Pass" title="Ingresa a Travel Pass" width="100" height="32" style="cursor: pointer;"></a>`;

		document
			.getElementById(profileData ? "open-profile-modal" : "open-login-modal")
