...
class PagePackMultienlaceInfo extends HTMLElement {
	connectedCallback() {
		this.innerHTML = `
            ...
            <app-banner-slider
                slides-data='[
                {"id": "slide1", "title": "Banner 1", "image": "../../src/assets/img/paqueteria/banner/pack-banner-multienlace.webp","mediumImage": "../../src/assets/img/banner/Tablet-1.png", "smallImage": "../../src/assets/img/banner/Movil-1.webp", "link": "#index.html/banner1"}
